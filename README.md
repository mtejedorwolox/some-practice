...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/some_practice?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/some_practice/badge)](http://codestats-url/organizations/your-organization/projects/some_practice/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/some_practice.git`
- Go to the project root by running `cd some_practice`
...
```bash
  ...
  CREATE ROLE "some_practice" LOGIN CREATEDB PASSWORD 'some_practice';
```
